...
public class ServletConsultaTaxi extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            rs= stmt.executeQuery("select TAXIS.PATENTE, TAXIS.MARCA, TAXIS.MODELO, TAXIS.COLOR FROM TAXIS WHERE PATENTE='"+patente+"'");
            
            out.println("<table width='600' border='1' align='center'");
            out.println("<tr>");
            out.println("<td colspan='6' align=center>DATOS DEL TAXI</td><td></td>");            
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td>Patente</td><td>Marca</td><td>Modelo</td><td>Color</td>");
            out.println("</tr>");
