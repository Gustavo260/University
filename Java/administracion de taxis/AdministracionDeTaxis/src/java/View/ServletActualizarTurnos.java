...
public class ServletActualizarTurnos extends HttpServlet {
    ...
    String campo=request.getParameter("campos2");
    int vali=0;
    Statement stmt=null;
    try
    {
            ...
            vali=stmt.executeUpdate("UPDATE ADMINTURNOS.TURNOS SET "+campo+"='"+valor+"' WHERE ORDENDETURNOS='"+orden+"'");
