...
public class ServletActualizarTaxi extends HttpServlet {
    ...
    String campo=request.getParameter("campos");
    int vali=0;
    Statement stmt=null;
    try
    {
            ...
            vali=stmt.executeUpdate("UPDATE TAXIS SET "+campo+"='"+valor+"' WHERE PATENTE='"+Patente+"'");
